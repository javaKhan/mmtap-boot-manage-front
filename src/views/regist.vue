<template>
    <Row type="flex" justify="center" align="middle" class="regist" @keydown.enter="submitRegist">
        <Col :xs="{span:22}" style="width: 368px;">
            <Row class="header">
                <img src="../images/mmtap-boot.png" width="220px"/>
            ...
            <Row class="foot">
                ...
                <Row type="flex" justify="center" class="code-row-bg copyright">
                    Copyright © 2018 <a href="http://www.imkzp.com" target="_blank" style="margin:0 5px;">imkzp.com</a> Presents
                </Row>
            </Row>
        </Col>
    </Row>
    ...
    getVerifyCode() {
      this.getRequest("/common/captcha/init").then(res => {
        if (res.success === true) {
          ...
          this.verifyCodeImg = "/mmtap/common/captcha/draw/" + this.captchaId;
        }
      });
    }
  },
